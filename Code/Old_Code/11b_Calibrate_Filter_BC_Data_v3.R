...
#' the I-25 site
#' 
#' In this version of the script, the independent variable is the monitor data
#' =============================================================================
...
start <- as.Date("01/01/2017", format = "%m/%d/%Y")
...
ggplot(cal_data, aes(y = monitor_mean, x = bc_ug_m3)) +
  geom_point(aes(color = as.factor(campaign)), show.legend = T) +
  geom_smooth(method = "lm", show.legend = F) +
  scale_color_viridis(name = "Campaign", discrete = T) +
  xlab("UPAS BC (\u03bcg/m\u00b3)") + 
  ylab("Monitor PM\u2082.\u2085 (\u03bcg/m\u00b3)") +
  simple_theme
...
ggplot() +
  geom_smooth(data = filter(cal_data, campaign == "Campaign2"),
              aes(y = monitor_mean, x = bc_ug_m3, color = campaign),
  ...
  xlab("UPAS BC (\u03bcg/m\u00b3)") + ylab("Monitor BC (\u03bcg/m\u00b3)") +
  simple_theme
ggsave(filename = here::here("Figs/Calibration", "BC_Cal_Curves_by_Campaign.jpeg"),
       height = 5, width = 8, dpi = 500, units = "in", device = "jpeg")
...
#' I25-Denver: R2 = -0.05
i25_lm <- lm(monitor_mean ~ bc_ug_m3,  
...
#' Assume equal variance in errors (orthoganol regression)
#' -----------------------------------------------------------------------------

library(deming)

i25_dem <- deming(monitor_mean ~ bc_ug_m3,  
                  data = filter(cal_data, monitor_id == "080310027"))
print(i25_dem)
...
plot(cal_data$bc_ug_m3, cal_data$monitor_mean, 
     ...
     ylab = "EPA Monitor", xlab = "UPAS Filter")
...
#' -------------------------------------
#' Summer = Campaign2
#' lm: adjusted R2 = -0.03; MAE = 0.21; RMSE = 0.24 
#' dem: MAE = 0.21; RMSE = 0.24 
#' -------------------------------------
...
i25_lm_summer <- lm(monitor_mean ~ bc_ug_m3, data = cal_data_summer)
...
i25_dem_summer <- deming(monitor_mean ~ bc_ug_m3, data = cal_data_summer)
...
i25_lm_fall <- lm(monitor_mean ~ bc_ug_m3, data = cal_data_fall)
summary(i25_lm_fall)
par(mfrow=c(2,2))
plot(i25_lm_fall)
par(mfrow=c(1,1))
...
i25_dem_fall <- deming(monitor_mean ~ bc_ug_m3, data = cal_data_fall)
print(i25_dem_fall)
...
i25_lm_winter <- lm(monitor_mean ~ bc_ug_m3, data = cal_data_winter)
...
i25_dem_winter <- deming(monitor_mean ~ bc_ug_m3, data = cal_data_winter)
...
#' adjusted R2 = -0.11
i25_lm1 <- lm(monitor_mean ~ bc_ug_m3 + monitor_temp, data = cal_data2)
summary(i25_lm1)
par(mfrow=c(2,2))
plot(i25_lm1)
par(mfrow=c(1,1))
...
#' adjusted R2 = -0.13
i25_lm1a <- lm(monitor_mean ~ bc_ug_m3 + monitor_temp + monitor_temp_sq, 
               data = cal_data2)
summary(i25_lm1a)
par(mfrow=c(2,2))
plot(i25_lm1a)
...
#' adjusted R2 = 0.25
i25_lm1b <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm, 
               data = cal_data2)
summary(i25_lm1b)
par(mfrow=c(2,2))
plot(i25_lm1b)
...
#' adjusted R2 = 0.24
i25_lm1c <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm + monitor_pm_sq, 
               data = cal_data2)
summary(i25_lm1c)
par(mfrow=c(2,2))
plot(i25_lm1c)
...
#' adjusted R2 = 0.19
i25_lm1d <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm + monitor_temp, 
               data = cal_data2)
summary(i25_lm1d)
par(mfrow=c(2,2))
plot(i25_lm1d)
...
#' Fit linear regression model with indicators for campaign
#' adjusted R2 = -0.19
i25_lm1e <- lm(monitor_mean ~ bc_ug_m3 + camp3 + camp4, 
              data = cal_data2)
summary(i25_lm1e)
par(mfrow=c(2,2))
plot(i25_lm1e)
...
#' MAE and RMSE- Linear model
mae(i25_lm1e$residuals)
rmse(i25_lm1e$residuals)

#' Fit linear regression model with indicators for pm2.5 and campaign 
#' adjusted R2 = 0.19
i25_lm1f <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm + camp3 + camp4, 
               data = cal_data2)
summary(i25_lm1f)
par(mfrow=c(2,2))
plot(i25_lm1f)
...
#' MAE and RMSE- Linear model
mae(i25_lm1f$residuals)
rmse(i25_lm1f$residuals)

#' -----------------------------------------------------------------------------
#' Because there seems to be a difference in how the curve fits for different 
#' campaigns (i.e., the indicator variables improved model fit somewhat), 
...
#' Fit linear regression model with temp
#' adjusted R2 = 0.28
i25_lm1_summer <- lm(monitor_mean ~ bc_ug_m3 + monitor_temp, 
...
#' Fit linear regression model with temp + temp_sq
#' adjusted R2 = 0.91
i25_lm1a_summer <- lm(monitor_mean ~ bc_ug_m3 + monitor_temp + monitor_temp_sq, 
                     data = cal_data2_summer)
...
#' Fit linear regression model with pm2.5
#' adjusted R2 = -0.39
i25_lm1b_summer <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm, 
                      data = cal_data2_summer)
...
#' Fit linear regression model with pm2.5 + temp
#' adjusted R2 = 0.44
i25_lm1c_summer <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm + monitor_temp, 
                      data = cal_data2_summer)
...
#' Fit linear regression model with pm2.5 + pm2.5_sq
#' adjusted R2 = 0.78
i25_lm1d_summer <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm + monitor_pm_sq,
                    data = cal_data2_summer)
...
#' Fit linear regression model with temp
#' adjusted R2 = -0.34
i25_lm1_fall <- lm(monitor_mean ~ bc_ug_m3 + monitor_temp, 
                     data = cal_data2_fall)
...
#' Fit linear regression model with temp + temp_sq
#' adjusted R2 = 0.79
i25_lm1a_fall <- lm(monitor_mean ~ bc_ug_m3 + monitor_temp + monitor_temp_sq, 
                      data = cal_data2_fall)
...
#' Fit linear regression model with pm2.5
#' adjusted R2 = -0.18
i25_lm1b_fall <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm, 
                      data = cal_data2_fall)
...
#' Fit linear regression model with pm2.5 + temp
#' adjusted R2 = 0.95
i25_lm1c_fall <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm + monitor_temp, 
                      data = cal_data2_fall)
...
#' Fit linear regression model with pm2.5 + pm2.5_sq
#' adjusted R2 = -0.61
i25_lm1d_fall <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm + monitor_pm_sq, 
                      data = cal_data2_fall)
...
#' Fit linear regression model with temp
#' adjusted R2 = -0.26
i25_lm1_winter <- lm(monitor_mean ~ bc_ug_m3 + monitor_temp, 
...
#' Fit linear regression model with temp + temp_sq
#' adjusted R2 = 0.60
i25_lm1a_winter <- lm(monitor_mean ~ bc_ug_m3 + monitor_temp + monitor_temp_sq, 
                    data = cal_data2_winter)
...
#' Fit linear regression model with pm2.5
#' adjusted R2 = 0.21
i25_lm1b_winter <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm, 
                    data = cal_data2_winter)
...
#' Fit linear regression model with pm2.5 + temp
#' adjusted R2 = 0.411
i25_lm1c_winter <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm + monitor_temp, 
                    data = cal_data2_winter)
...
#' Fit linear regression model with pm2.5 + pm2.5_sq
#' adjusted R2 = 0.08
i25_lm1d_winter <- lm(monitor_mean ~ bc_ug_m3 + monitor_pm + monitor_pm_sq, 
                      data = cal_data2_winter)
...
summary(i25_lm1_summer) 
summary(i25_lm1a_summer) # Adjusted R2 = 0.91
summary(i25_lm1b_summer) 
summary(i25_lm1c_summer) 
summary(i25_lm1d_summer) 

AIC(i25_lm1_summer) 
AIC(i25_lm1a_summer) # AIC = -7.58
AIC(i25_lm1b_summer) 
AIC(i25_lm1c_summer) 
AIC(i25_lm1d_summer) 

mae(i25_lm1_summer$residuals) 
mae(i25_lm1a_summer$residuals) # MAE = 0.04
mae(i25_lm1b_summer$residuals) 
mae(i25_lm1c_summer$residuals) 
mae(i25_lm1d_summer$residuals) 
...
summary(i25_lm1a_fall) 
summary(i25_lm1b_fall) 
summary(i25_lm1c_fall) # Adjusted R2 = 0.95
summary(i25_lm1d_fall) 

AIC(i25_lm1_fall) 
AIC(i25_lm1a_fall) 
AIC(i25_lm1b_fall) 
AIC(i25_lm1c_fall) # AIC = -10.13
AIC(i25_lm1d_fall) 

mae(i25_lm1_fall$residuals) 
mae(i25_lm1a_fall$residuals) 
mae(i25_lm1b_fall$residuals) 
mae(i25_lm1c_fall$residuals) # MAE = 0.03
mae(i25_lm1d_fall$residuals) 

rmse(i25_lm1_fall$residuals) 
rmse(i25_lm1a_fall$residuals) 
rmse(i25_lm1b_fall$residuals) 
rmse(i25_lm1c_fall$residuals) # RMSE = 0.04
rmse(i25_lm1d_fall$residuals) 
...
summary(i25_lm1_winter) 
summary(i25_lm1a_winter) # Adjusted R2 = 0.60
summary(i25_lm1b_winter) 
summary(i25_lm1c_winter) 
summary(i25_lm1d_winter) 

AIC(i25_lm1_winter) 
AIC(i25_lm1a_winter) # AIC = 4.63
AIC(i25_lm1b_winter) 
AIC(i25_lm1c_winter) 
AIC(i25_lm1d_winter) 

mae(i25_lm1_winter$residuals) 
mae(i25_lm1a_winter$residuals) # MAE = 0.12
mae(i25_lm1b_winter$residuals) 
mae(i25_lm1c_winter$residuals) 
mae(i25_lm1d_winter$residuals) 

rmse(i25_lm1_winter$residuals) 
rmse(i25_lm1a_winter$residuals) # RMSE = 0.15
rmse(i25_lm1b_winter$residuals) 
rmse(i25_lm1c_winter$residuals) 
rmse(i25_lm1d_winter$residuals) 
...
#' -------------------------------------
#' Summer = Campaign2
#' Predictors: monitor_temp, monitor_temp_sq
#' -------------------------------------

fit_lm_summer <- i25_lm1a_summer
summary(fit_lm_summer)

#' Calibrating the filter data
fit_data_summer <- filter(cal_data2, campaign == "Campaign2") 

fit_data_summer <- fit_data_summer %>% 
  #' Calibrated BC (adjusted linear model)
  mutate(bc_ug_m3_adjlm = predict(fit_lm_summer, newdata = fit_data_summer)) %>% 
  #' Calibrated BC (crude linear model) %>% 
  mutate(bc_ug_m3_lm = lm_int_summer + (bc_ug_m3 * lm_slope_summer)) %>% 
  #' Calibrated BC (Deming model) 
  mutate(bc_ug_m3_dem = dem_int_summer + (bc_ug_m3 * dem_slope_summer))

#' MAE and RMSE- Adjusted linear model
mae(fit_lm_summer$residuals)
rmse(fit_lm_summer$residuals)
...
#' -------------------------------------
#' Fall = Campaign3
#' Predictors: monitor_pm, monitor_temp
#' -------------------------------------

fit_lm_fall <- i25_lm1c_fall
summary(fit_lm_fall)

#' Calibrating the filter data
fit_data_fall <- filter(cal_data2, campaign == "Campaign3") 

fit_data_fall <- fit_data_fall %>% 
  #' Calibrated BC (adjusted linear model)
  mutate(bc_ug_m3_adjlm = predict(fit_lm_fall, newdata = fit_data_fall)) %>% 
  #' Calibrated BC (crude linear model) %>% 
  mutate(bc_ug_m3_lm = lm_int_fall + (bc_ug_m3 * lm_slope_fall)) %>% 
  #' Calibrated BC (Deming model) 
  mutate(bc_ug_m3_dem = dem_int_fall + (bc_ug_m3 * dem_slope_fall))

#' MAE and RMSE- Adjusted linear model
mae(fit_lm_fall$residuals)
rmse(fit_lm_fall$residuals)
...
fit_lm_winter <- i25_lm1a_winter
summary(fit_lm_winter)

#' Calibrating the filter data
fit_data_winter <- filter(cal_data2, campaign == "Campaign4") 

fit_data_winter <- fit_data_winter %>% 
  #' Calibrated BC (adjusted linear model)
  mutate(bc_ug_m3_adjlm = predict(fit_lm_winter, newdata = fit_data_winter)) %>% 
  #' Calibrated BC (crude linear model) %>% 
  mutate(bc_ug_m3_lm = lm_int_winter + (bc_ug_m3 * lm_slope_winter)) %>% 
  #' Calibrated BC (Deming model) 
  mutate(bc_ug_m3_dem = dem_int_winter + (bc_ug_m3 * dem_slope_winter))

#' MAE and RMSE- Adjusted linear model
mae(fit_lm_winter$residuals)
rmse(fit_lm_winter$residuals)
...
filters_summer <- filters_summer %>% 
  #' Calibrated BC (adjusted linear model)
  mutate(bc_ug_m3_adjlm = predict(fit_lm_summer, newdata = filters_summer)) %>% 
  #' Calibrated BC (crude linear model) %>% 
  mutate(bc_ug_m3_lm = lm_int_summer + (bc_ug_m3 * lm_slope_summer)) %>% 
  #' Calibrated BC (Deming model) 
  mutate(bc_ug_m3_dem = dem_int_summer + (bc_ug_m3 * dem_slope_summer))
...
filter_summer_comp <- filters_summer %>% 
  select(filter_id, campaign, bc_ug_m3, bc_ug_m3_adjlm, bc_ug_m3_lm, bc_ug_m3_dem, monitor_mean) %>% 
...
ggplot(filter_summer_comp, aes(x = as.factor(type), y = bc, fill = as.factor(type))) +
  ...
  scale_fill_viridis(name = "Data Type", discrete = T, 
                     labels = c("bc_ug_m3" = "Raw Data",
                                "bc_ug_m3_adjlm" = "Adjusted linear model",
  ...
  simple_theme
ggsave(filename = here::here("Figs/Calibration", "BC_Summer_Raw_Calibrated.jpeg"),
...
filters_fall <- filters_fall %>% 
  #' Calibrated BC (adjusted linear model)
  mutate(bc_ug_m3_adjlm = predict(fit_lm_fall, newdata = filters_fall)) %>% 
  #' Calibrated BC (crude linear model) %>% 
  mutate(bc_ug_m3_lm = lm_int_fall + (bc_ug_m3 * lm_slope_fall)) %>% 
  #' Calibrated BC (Deming model) 
  mutate(bc_ug_m3_dem = dem_int_fall + (bc_ug_m3 * dem_slope_fall))
...
ggplot(filter_fall_comp, aes(x = as.factor(type), y = bc, fill = as.factor(type))) +
  ...
  theme(legend.position = c(0.8, 0.8)) +
  simple_theme
ggsave(filename = here::here("Figs/Calibration", "BC_Fall_Raw_Calibrated.jpeg"),
       height = 4, width = 6, dpi = 500, units = "in", device = "jpeg")
...
filters_winter <- filters_winter %>% 
  #' Calibrated BC (adjusted linear model)
  mutate(bc_ug_m3_adjlm = predict(fit_lm_winter, newdata = filters_winter)) %>% 
  #' Calibrated BC (crude linear model) %>% 
  mutate(bc_ug_m3_lm = lm_int_winter + (bc_ug_m3 * lm_slope_winter)) %>% 
  #' Calibrated BC (Deming model) 
  mutate(bc_ug_m3_dem = dem_int_winter + (bc_ug_m3 * dem_slope_winter))
...
ggplot(filter_winter_comp, aes(x = as.factor(type), y = bc, fill = as.factor(type))) +
  ...
  theme(legend.position = c(0.8, 0.8)) +
  simple_theme
ggsave(filename = here::here("Figs/Calibration", "BC_Winter_Raw_Calibrated.jpeg"),
       height = 4, width = 6, dpi = 500, units = "in", device = "jpeg")
...
#' of lower AE-33 concentrations in the spring
#' -------------------------------------
...
filters_spring <- filter(filter_data2, campaign == "Campaign1")
summary(filters_spring$monitor_mean)
summary(filters_summer$monitor_mean)
summary(filters_fall$monitor_mean)
summary(filters_winter$monitor_mean)
...
filters_spring_fall <- filters_spring_fall %>% 
  #' Calibrated BC (adjusted linear model)
  mutate(bc_ug_m3_adjlm = predict(fit_lm_fall, newdata = filters_spring_fall)) %>% 
  #' Calibrated BC (crude linear model) %>% 
  mutate(bc_ug_m3_lm = lm_int_fall + (bc_ug_m3 * lm_slope_fall)) %>% 
  #' Calibrated BC (Deming model) 
  mutate(bc_ug_m3_dem = dem_int_fall + (bc_ug_m3 * dem_slope_fall))
...
ggplot(filter_spring_fall_comp, aes(x = as.factor(type), y = bc, fill = as.factor(type))) +
  ...
  theme(legend.position = c(0.8, 0.8)) +
  simple_theme
ggsave(filename = here::here("Figs/Calibration", "BC_Spring_Fall_Raw_Calibrated.jpeg"),
       height = 4, width = 6, dpi = 500, units = "in", device = "jpeg")

#' Next, try the summer model
filters_spring_summer <- filter(filter_data2, campaign == "Campaign1")

filters_spring_summer <- filters_spring_summer %>% 
  #' Calibrated BC (adjusted linear model)
  mutate(bc_ug_m3_adjlm = predict(fit_lm_summer, newdata = filters_spring_summer)) %>% 
  #' Calibrated BC (crude linear model) %>% 
  mutate(bc_ug_m3_lm = lm_int_summer + (bc_ug_m3 * lm_slope_summer)) %>% 
  #' Calibrated BC (Deming model) 
  mutate(bc_ug_m3_dem = dem_int_summer + (bc_ug_m3 * dem_slope_summer))
...
ggplot(filter_spring_summer_comp, aes(x = as.factor(type), y = bc, fill = as.factor(type))) +
  ...
  theme(legend.position = c(0.8, 0.8)) +
  simple_theme
ggsave(filename = here::here("Figs/Calibration", "BC_Spring_Summer_Raw_Calibrated.jpeg"),
       height = 4, width = 6, dpi = 500, units = "in", device = "jpeg")

#' Check the winter model as well just in case
filters_spring_winter <- filter(filter_data2, campaign == "Campaign1")

filters_spring_winter <- filters_spring_winter %>% 
  #' Calibrated BC (adjusted linear model)
  mutate(bc_ug_m3_adjlm = predict(fit_lm_winter, newdata = filters_spring_winter)) %>% 
  #' Calibrated BC (crude linear model) %>% 
  mutate(bc_ug_m3_lm = lm_int_winter + (bc_ug_m3 * lm_slope_winter)) %>% 
  #' Calibrated BC (Deming model) 
  mutate(bc_ug_m3_dem = dem_int_winter + (bc_ug_m3 * dem_slope_winter))
...
ggplot(filter_spring_winter_comp, aes(x = as.factor(type), y = bc, fill = as.factor(type))) +
  ...
  theme(legend.position = c(0.8, 0.8)) +
  simple_theme
ggsave(filename = here::here("Figs/Calibration", "BC_Spring_Winter_Raw_Calibrated.jpeg"),
       height = 4, width = 6, dpi = 500, units = "in", device = "jpeg")
...
filter_data_comp <- filter_data3 %>% 
  select(filter_id, month, season, bc_ug_m3, bc_ug_m3_adjlm, 
...
ggplot(filter_data_comp, aes(x = as.factor(month), y = bc, fill = as.factor(type))) +
  ...
  scale_fill_viridis(name = "Data Type", discrete = T, 
                     labels = c("bc_ug_m3" = "Raw Data",
                                "bc_ug_m3_adjlm" = "Adj. linear model",
                                "bc_ug_m3_lm" = "Crude linear model",
                                "bc_ug_m3_dem" = "Deming model",
...
ggplot() +
  geom_point(data = filter(cal_data, campaign == "Campaign2"),
             aes(y = monitor_mean, x = bc_ug_m3, color = campaign), size = 2) +
