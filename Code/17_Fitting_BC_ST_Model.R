...
#' -----------------------------------------------------------------------------
#' Read in the filter data and get it in the correct shape for the SpatioTemporal 
#' package
#' -----------------------------------------------------------------------------
...
#' We need to combine monitoring data for NO2, BC, and PM2.5 in order to 
#' calculate the time trends.
#' -----------------------------------------------------------------------------
...
#' The cross validation results for generating the time trends suggest 2 basis 
#' functions is the way to go, but let's see if that holds up with our data
#' -----------------------------------------------------------------------------
...
#' I also checked out 4 and 8 df per year
...
save(pol_STdata2, file = here::here("Results", "Denver_ST_Monitors.rdata"))
...
#' -----------------------------------------------------------------------------
#' Updated the denver.data object with the new trend data
#' The next step is to update the trend data for the denver.data object 
#' and see if these trend data fit our observations.
#' 
#' Comparing the plots using one basis function vs. two basis functions, it looks 
#' like using two basis functions might be better than 1. There was some residual 
#' autocorrelation in the central site monitor data when using just one basis 
#' function (see the fourth plot in the first series of plots below). Using 8 
#' degrees of freedom did not help. Using two basis functions helped somewhat to 
#' reduce this autocorrelation, but it still persists. There are still some 
#' noticeable trends in the residuals for the central monitoring site
#' -----------------------------------------------------------------------------
...
#' Building on the results of the previous modeling efforts, I'm going to update 
#' "Model 4.2", which used an exp covariance structure for the error term 
#' and iid  for the beta fields.
#' -----------------------------------------------------------------------------
